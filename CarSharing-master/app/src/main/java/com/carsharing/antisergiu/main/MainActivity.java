...
public class MainActivity extends Activity {
   ...
   //     new GcmRegistrationAsyncTask().execute(this);
    ...
    public void createPool(View view) {
        Intent createPoolIntent = new Intent(this, MapsActivity.class);
        createPoolIntent.putExtra("source" , "1") ;
        startActivity(createPoolIntent);
    }

    public void searchRoutes(View view) {
        Intent searchPoolIntent = new Intent(this, MapsActivity.class);
        searchPoolIntent.putExtra("source" , "2") ;
